...
class SkippableSequencePatch
{
    ...
    {
        if (!QoLPlugin.NoCutscenes.Value || GameManager.instance.sceneName.Equals("End_Game_Completion")) return true;
...
class InputHandlerPatch
{
    ...
    static bool Prefix(InputHandler __instance, ref SkipPromptMode newMode)
    {
        ...
        && !sceneName.Equals("Cinematic_Stag_travel") && !sceneName.Equals("Belltown_Room_pinsmith")) return true;
